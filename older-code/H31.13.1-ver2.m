...
QmuX<X> := PolynomialRing(Qmu);

/* Alternative strategy -- build Kmu as extension over Qmu */

Kmu := RelativeField(Qmu, QmuX!minpoly_K);

b := Kmu!a;

coeffs := [0, 0, 1, 186930*b - 427490, 58571989*b - 135261471];
