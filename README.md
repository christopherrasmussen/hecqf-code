...
```
magma show_torsion:=y heavenly-test.m
```
...
[HL15] H. Daniels and Á. Lozano-Robledo, "On the number of isomorphism classes of CM elliptic curves defined over a number field," *J. Number Theory* 157 (2015), pp. 367--396. 
